...
public class VRMenuManager : MonoBehaviour
{
            ...
            case EMenuState.eHiding:
                {
                    ...
                    {
                        transform.localScale = Vector3.zero;
                        transform.position = m_Wand.transform.position;
                        transform.rotation = m_Wand.transform.rotation;
    ...
    public void UseVRMenu(bool iUseVRMenu)
    {
        ...
        // Hide and deactivate
        GetComponent<Renderer>().enabled = m_IsMenuUsed;
        GetComponent<Collider>().enabled = m_IsMenuUsed;

        int childrenNb = transform.childCount;
